...
<body>
    ...
    <nav>
        ...
        <div class="navbar" id="navbar">
            <ul class="links">
                <li class="nav-links">
                    <a href="./admin/samsung.php" class="link"><strong>Samsung</strong></a>
                </li>
                <li class="nav-links">
                    <a href="./admin/xiaomi.php" class="link"><strong>Xiaomi</strong></a>
                </li>
                <li class="nav-links">
                    <a href="./admin/oppo.php" class="link"><strong>Oppo</strong></a>
                </li>
                <li class="nav-links">
                    <a href="./admin/nokia.php" class="link"><strong>Nokia</strong></a>
                </li>
                <li class="nav-links">
                    <a href="./admin/iphone.php" class="link"><strong>Iphone</strong></a>
                </li>
                <li class="nav-links">
                    <a href="./admin/vivo.php" class="link"><strong>Vivo</strong></a>
                </li>
                <li class="nav-links">
                    <a href="./admin/asus.php" class="link"><strong>ASUS</strong></a>
                </li>
                <li class="nav-links">
                    <a href="./admin/realme.php" class="link"><strong>Realme</strong></a>
                </li>
            </ul>
