...
for (var i = 0; i < add_cart.length; i++) {
  ...
  add.addEventListener("click", function (event) {
    ...
    var img =
      product.parentElement.getElementsByClassName("img-product")[0].src;
    var title =
      product.parentElement.getElementsByClassName("productName")[0].innerText;
    var price =
      product.parentElement.getElementsByClassName("priceValue")[0].innerText;
